...
function LocationwiseTable(props) {
            ...
            fn: items => {
                ...
                if (target.value == "")
                    ...
                    //  value.material_no.includes(target.value.toLowerCase())
                        ...
                        // || value.itemName.toLowerCase().includes(target.value.toLowerCase())
                         || value.location[0].toLowerCase().includes(target.value.toLowerCase())
    ...
    const { TblContainer, TblHead, TblPagination, recordsAfterPagingAndSorting } = useTable(updatedRecords, locationwiseHeader, filterFn);
    ...
    return (
            <div className={classes.pageContent} style={{ marginBottom: "10px" }}>       
                <span style={{fontSize: "15px" , marginBottom:"10px"}} > (Total Item : {updatedRecords?.length ? updatedRecords?.length : 0 })</span>
                    ...
                    <form class="form-inline border" autoComplete="off" >                  
                        <div class="input-group" >        
                            <input
                                ...
                                type="text"
                                name="searchText"
                                placeholder= "Search item by ItemName or Location"
                ...
                <div >
                    <div className='row'>
                        <div className='p-0 justify-content-between'>
                            <LocalizationProvider dateAdapter={AdapterDateFns} style={{ marginRight: "10px", width: "10vw" ,}}>
                                <DesktopDatePicker 
                                    label="From"
                                ...
                                />
                                 ...
                                 &nbsp;&nbsp;&nbsp;&nbsp;
                            <CButton  onClick={props.getFilterReportData(filterDateData)} style={{ marginTop:"5px" , width: '80px', height: '50px'}} color="success">
                                Filter
                            </CButton>
                        </div>
                    </div>
                            ...
                            recordsAfterPagingAndSorting().length > 0 ? (
                                recordsAfterPagingAndSorting().map((record, index) => (
                                    <TableRow key={record._id} >
                                        ...
                                        <TableCell >{record?.location[0]}</TableCell>
...
export default LocationwiseTable;
