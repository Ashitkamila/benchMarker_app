...
import MarketwiseTable from './marketwisetable';
import {
    CButton,
    CCol,
    CContainer,
...
function Marketwisereport(props) {
    ...
    function getData() {
        props.actions.getmarketwise().then(res => {
    ...
    return (
        <div className="w-100 p-2 pt-3" style={{ height: "calc(100% - 64px)", overflow: "auto" }}>
            <div className="mt-2 row">
                <div className="col-6">
                    <h5 style={{ color: "#676767" }}>Market Wise Reports</h5>
                </div>
                <div className="col-6 ">
...
export default connect(mapStateToProps, mapDispatchToProps)(Marketwisereport)